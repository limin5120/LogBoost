...
from logboost.models.lstm import loganomaly
...
options = {
    ...
    'save_interval': 100,
    # Predict
    'model_path': "../result/loganomaly/loganomaly_last.pth",
    'resume_path': None,
}
...
# -- HDFS-A origin
# > python loganomaly.py train hdfs deep origin cpu
# > python loganomaly.py predict hdfs deep origin cpu
# > python loganomaly.py evaluation hdfs deep origin cpu

# -- HDFS-A boost
# > python loganomaly.py train hdfs deep boost cpu
# > python loganomaly.py predict hdfs deep boost cpu
# > python loganomaly.py evaluation hdfs deep boost cpu

# -- HDFS-B origin
# > python loganomaly.py train hdfs swiss origin cpu
# > python loganomaly.py predict hdfs swiss origin cpu
# > python loganomaly.py evaluation hdfs swiss origin cpu

# -- HDFS-B boost
# > python loganomaly.py train hdfs swiss boost cpu
# > python loganomaly.py predict hdfs swiss boost cpu
# > python loganomaly.py evaluation hdfs swiss boost cpu

# -- SPARK origin
# > python loganomaly.py train spark spark origin cpu
# > python loganomaly.py predict spark spark origin cpu
# > python loganomaly.py evaluation spark spark origin cpu

# -- SPARK boost
# > python loganomaly.py train spark spark boost cpu
# > python loganomaly.py predict spark spark boost cpu
# > python loganomaly.py evaluation spark spark boost cpu